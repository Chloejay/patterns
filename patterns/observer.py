'''
the hardcore of observer pattern is pub/sub originated from event streaming concept, which uses the one-to-many structure. 
...
#implement with a simple version 
class Event:
    _observers=list() 
